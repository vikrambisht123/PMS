...
.footer{            
  ...
  <ul><center><h1><div class="header">Payroll Management System</div></h1></center></ul>
   ...
   <div id="head">
<br><br><h1><center>Employee Details</center></h1></div>
     </div>
    <div id="container">
	<form   name="myform" method="post" action="Employee Detail.jsp" onsubmit="return validate()">
	...
	<table>
	 ...
	 <tr>
	   ...
	   <tr>
	    <td>Employee Name</td>
	    <td><input type="text"  name="en" placeholder="Your Name" required></td>
	  </tr>
	
	
	<tr>
	<td>Mobile Number </td>
	<td><input type="text" name="mn"  maxlength="10"  pattern="[0-9]{10}" placeholder="Mobile number" required></td>
	</tr>
   ...
   <br><br><br><br><br><br><br><br><div class="footer">
